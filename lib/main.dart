        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              _buildInfo("Kapasite", accessPoint.capabilities),
              _buildInfo("Frekans", "${accessPoint.frequency}MHz"),
              _buildInfo("level", accessPoint.level),
              _buildInfo("standart", accessPoint.standard),
              _buildInfo(
                  "Merkez Frekans0", "${accessPoint.centerFrequency0}MHz"),
              _buildInfo(
                  "Merkez Frekans1", "${accessPoint.centerFrequency1}MHz"),
              _buildInfo("Kanal Genişliği", accessPoint.channelWidth),
            ],
          ),
        ),
      ),
